  ...
  return (
    <Link
      ...
      className={`flex items-center space-x-3 py-3 px-4 ${
        active ? 'text-primary bg-blue-50 border-r-4 border-primary border- ' : 'text-subtitle hover:bg-gray-100'
      }`}
    >
...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="bg-white w-56 min-h-screen border-r border-gray-200">
      <div className="py-4">
        <SidebarItem
        ...
        <SidebarItem
          ...
          label="Committees"
          to="/committees"
          active={location.pathname === '/committees'}
        />
        <SidebarItem
